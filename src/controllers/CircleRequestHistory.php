<?php
function CircleRequestHistory(PDO $dbh, string $circle_id): array
{
    $query = "SELECT 
        r.id AS request_id, 
    ...
    JOIN circle_members cm ON cm.circle_id = s.circle_member_id
    ...
    WHERE cm.circle_id = :circle_id AND r.is_completed = 1
